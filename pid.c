...
void pid_set_sub_cmd (arm_pid_t *pid, int32_t cmd)
{
	pid->subcmd = cmd;
}
...
inline void pid_set_PWM (arm_pid_t *pid, int32_t duty)
{
...
{	
	...
	*pid->encoder = 0;
	...
	case SPEED:
		...
		/* Round fixed point value */
		pidcmd = out >> FIXED_POINT_POSITION;
		__attribute__ ((fallthrough));
		
	case TORQUE:	// No torque contol
	case PWM:
